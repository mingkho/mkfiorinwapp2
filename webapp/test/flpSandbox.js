		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#mkfiorinwapp2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mkfiorinwapp2-display": {
								"semanticObject": "mkfiorinwapp2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mkfiorinwapp2",
									"url": sap.ui.require.toUrl("mkfiorinwapp2")
								}
							}
						}
					}
